...
namespace eval ::optrace {
  variable script "C:/dev/CompuTED/CompuTED/CompuTED.runs/impl_1/core.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/dev/CompuTED/CompuTED/CompuTED.cache/wt [current_project]
  set_property parent.project_path C:/dev/CompuTED/CompuTED/CompuTED.xpr [current_project]
  set_property ip_output_repo C:/dev/CompuTED/CompuTED/CompuTED.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/dev/CompuTED/CompuTED/CompuTED.runs/synth_1/core.dcp
OPTRACE "read constraints: implementation" START { }
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top core -part xc7k70tfbv676-1 
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file core_timing_summary_routed.rpt -pb core_timing_summary_routed.pb -rpx core_timing_summary_routed.rpx -warn_on_violation "
