...
HD_PWD='C:/dev/CompuTED/CompuTED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataMemoryTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataMemoryTest.tcl
